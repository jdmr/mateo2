			...
			<ol class="property-list folioInventario">
				...
				<li class="fieldcontain">
					<span id="almacen-label" class="property-label"><g:message code="folioInventario.almacen.label" default="Almacen" /></span>
						...
						<span class="property-value" aria-labelledby="almacen-label"><g:link controller="almacen" action="show" id="${folioInventario?.almacen?.id}">${folioInventario?.almacen?.encodeAsHTML()}</g:link></span>
