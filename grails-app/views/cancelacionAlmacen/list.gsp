	...
	<body>
		...
		<div id="list-cancelacionAlmacen" class="content scaffold-list" role="main">
			...
			<table>
				...
				<tbody>
				<g:each in="${cancelacionAlmacenInstanceList}" status="i" var="cancelacionAlmacenInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
					
						<td><g:link action="show" id="${cancelacionAlmacenInstance.id}">${fieldValue(bean: cancelacionAlmacenInstance, field: "folio")}</g:link></td>
					
						<td>${fieldValue(bean: cancelacionAlmacenInstance, field: "comentarios")}</td>
					
						<td>${fieldValue(bean: cancelacionAlmacenInstance, field: "entrada")}</td>
					
						<td>${fieldValue(bean: cancelacionAlmacenInstance, field: "salida")}</td>
					
						<td>${fieldValue(bean: cancelacionAlmacenInstance, field: "creador")}</td>
					
						<td>${fieldValue(bean: cancelacionAlmacenInstance, field: "almacen")}</td>
			...
			<div class="pagination">
				<g:paginate total="${cancelacionAlmacenInstanceTotal}" />
			</div>
		</div>
	</body>
</html>
